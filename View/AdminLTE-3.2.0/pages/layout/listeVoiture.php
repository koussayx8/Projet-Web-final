...
$results_per_page = 4;
$listVoiture=$VoitureC->getAllarticles();
//var_dump(is_countable($listVoiture));
//var_dump(count($listVoiture));
$number_of_result = count($listVoiture);
...
if(isset($_POST['tri'])){
  $listVoiture=$VoitureC->tri($_POST['tri']);
} elseif (isset($_GET['recherche'])) {
  $listVoiture=$VoitureC->recherche($_GET['recherche']);
}


else {
  //$listVoiture=$VoitureC->afficherNomMarque();
  $listVoiture=$VoitureC->afficherpagevoiture($page_first_result, $results_per_page);
            ...
            <table class="table table-bordered"  width="100%" cellspacing="0">
              ...
              <tbody>
                <tr>
                  ...
                  <td><?php echo $Voiture['nom_voiture']?></td>
                  <td><?php echo $Voiture['image']?></td>
                  <td><?php echo $Voiture['prix']?></td>
                  <td><?php echo $Voiture['description']?></td>
                  
                  <td>
                    <a href="EditV.php?id=<?php echo $IdV?>" class="badge badge-success">MODIFIER</a>
                    <a href="SupprimerVoiture.php?id=<?php echo $IdV;?>" class="badge badge-danger">SUPPRIMER</a>
                  </td>
                </tr>
              </tbody>
              <?php
  ...
  <div class="container-fluid pt-4 px-4">
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-6 text-center text-sm-start">
                            ...
                            <div class="pagination">
                                ...
                                if ($page >= 2) {
                                    echo "<a href='listeVoiture.php?page=" . ($page - 1) . "'>  Prev </a>";
                                }

                                for ($i = 1; $i <= $total_pages; $i++) {
                                    if ($i == $page) {
                                        $pagLink .= "<a class = 'active' href='listeVoiture.php?page="
                                            . $i . "'>" . $i . " </a>";
                                    } else {
                                        $pagLink .= "<a href='listeVoiture.php?page=" . $i . "'>   
                                                " . $i . " </a>";
                                    }
                                };
                                echo $pagLink;
                                ...
                                if ($page < $total_pages) {
                                    echo "<a href='listeVoiture.php?page=" . ($page + 1) . "'>  Next </a>";
                                }
                ...
                <script>
                    function go2Page() {
                        ...
                        window.location.href = 'listeVoiture.php?page=' + page;
                    }
                </script>
            </div>
...
<script>
    function createPDF() {
        ...
        win.document.write('<title>Liste voitures</title>');   // <title> FOR PDF HEADER.
